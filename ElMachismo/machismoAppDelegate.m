...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    PlayingCard * cardD = [[PlayingCard alloc]init];
    ...
    NSLog(@"cardD.contents: %@",cardD.contents);
    ...
    NSLog(@"[cardA setContents:@[cardB.contents, cardC.contents][0]]: %@",cardA.contents);
...
//    NSLog(@"[NSString stringWithFormat:@\"X\" cardB.contents]:%@",[NSString stringWithFormat:@"%@", cardB.contents]);
    ...
    [cardA setContents:cardD.contents];
    //[cardA setSuit:@"♥"];
    NSLog(@"cardA.contents: %@",cardA.contents);
    
    Card * cCardA = [[Card alloc]init];
    Card * cCardB = [[Card alloc]init];
    Card * cCardC = [[Card alloc]init];
    Card * cCardD = [[Card alloc]init];
    
    [cCardA setContents:@"mama"];
    [cCardB setContents:@"daniela"];
    [cCardC setContents:@"daniela"];
    [cCardD setContents:@"andres"];

    [cCardA setContents:[NSString stringWithFormat:@"%@", cCardD.contents]];
    NSLog(@"cCardA.contents: %@",cCardA.contents);
    
    cCardA.contents = @[cCardB.contents, cCardC.contents][[cCardB match:@[cCardC]] ? 1 : 0];
    NSLog(@"cCardA.contents: %@",cCardA.contents);
